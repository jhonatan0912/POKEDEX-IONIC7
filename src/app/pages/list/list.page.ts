...
import { IonInfiniteScroll, IonicModule, LoadingController } from '@ionic/angular';
    ...
    setTimeout(() => {
      this.pokeService.getPokemon(this.offset)
        .subscribe((res: any) => {
          ...
          if (this.offset === 100) { this.infiniteScroll.disabled = true; }
        })
    }, 1500);
  }
